package crusader.nikeshopping.models.retriveSingleItem;
...
@Expose
private crusader.nikeshopping.models.retriveSingleItem.Seller Seller;
@SerializedName("BidCount")
@Expose
private Integer BidCount;
@SerializedName("ConvertedCurrentPrice")
@Expose
private crusader.nikeshopping.models.retriveSingleItem.ConvertedCurrentPrice ConvertedCurrentPrice;
@SerializedName("CurrentPrice")
@Expose
private crusader.nikeshopping.models.retriveSingleItem.CurrentPrice CurrentPrice;
@SerializedName("HighBidder")
@Expose
private crusader.nikeshopping.models.retriveSingleItem.HighBidder HighBidder;
...
@Expose
private crusader.nikeshopping.models.retriveSingleItem.ReturnPolicy ReturnPolicy;
@SerializedName("MinimumToBid")
@Expose
private crusader.nikeshopping.models.retriveSingleItem.MinimumToBid MinimumToBid;
...
* The Seller
*/
public crusader.nikeshopping.models.retriveSingleItem.Seller getSeller() {
return Seller;
}
...
* The Seller
*/
public void setSeller(crusader.nikeshopping.models.retriveSingleItem.Seller Seller) {
this.Seller = Seller;
}
...
*/
public crusader.nikeshopping.models.retriveSingleItem.ConvertedCurrentPrice getConvertedCurrentPrice() {
...
* The ConvertedCurrentPrice
*/
public void setConvertedCurrentPrice(crusader.nikeshopping.models.retriveSingleItem.ConvertedCurrentPrice ConvertedCurrentPrice) {
...
* The CurrentPrice
*/
public crusader.nikeshopping.models.retriveSingleItem.CurrentPrice getCurrentPrice() {
return CurrentPrice;
}
...
* The CurrentPrice
*/
public void setCurrentPrice(crusader.nikeshopping.models.retriveSingleItem.CurrentPrice CurrentPrice) {
...
* The HighBidder
*/
public crusader.nikeshopping.models.retriveSingleItem.HighBidder getHighBidder() {
return HighBidder;
}
...
* The HighBidder
*/
public void setHighBidder(crusader.nikeshopping.models.retriveSingleItem.HighBidder HighBidder) {
...
* The ReturnPolicy
*/
public crusader.nikeshopping.models.retriveSingleItem.ReturnPolicy getReturnPolicy() {
return ReturnPolicy;
}
...
* The ReturnPolicy
*/
public void setReturnPolicy(crusader.nikeshopping.models.retriveSingleItem.ReturnPolicy ReturnPolicy) {
...
* The MinimumToBid
*/
public crusader.nikeshopping.models.retriveSingleItem.MinimumToBid getMinimumToBid() {
return MinimumToBid;
}
...
* The MinimumToBid
*/
public void setMinimumToBid(crusader.nikeshopping.models.retriveSingleItem.MinimumToBid MinimumToBid) {
